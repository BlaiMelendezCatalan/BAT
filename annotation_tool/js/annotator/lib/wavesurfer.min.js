...
!function (a, b) {
  ...
  var a = {
    defaultParams: {
      ...
      this.savedVolume = 0, this.isMuted = !1, this.tmpEvents = [], this.currentAjax = null, this.createDrawer(), this.createBackend()
  ...
  return a.create = function (b) {
    ...
    init: function (a, b) {
      ...
      a.preventDefault();
      var b, c = this.wrapper.getBoundingClientRect(), d = this.width, e = this.getWidth();
    ...
    initDrawer: function (a) {
      ...
      a.waveCtx.canvas.width = b, a.waveCtx.canvas.height = c, this.style(a.waveCtx.canvas, {width: d + "px"}), this.style(this.progressWave, {display: "block"}), this.hasProgressCanvas && (a.progressCtx.canvas.width = b, a.progressCtx.canvas.height = c, this.style(a.progressCtx.canvas, {width: d + "px"}))
      ...
      var f = this.width, g = this.params.height * this.params.pixelRatio, h = g * c || 0, i = g / 2, j = b.length, k = this.params.barWidth * this.params.pixelRatio, l = Math.max(this.params.pixelRatio, ~~(k / 2)), m = k + l, n = 1;
      ...
      var i = this.params.height * this.params.pixelRatio, j = i * c || 0, k = i / 2, l = ~~(b.length / 2), m = 1;
      this.params.fillParent && this.width != l && (m = this.width / l);
      var n = 1;
      if (this.params.normalize) {
        var o = a.util.max(b), p = a.util.min(b);
        n = -p > o ? -p : o
      }
      ...
      if (a) {
        var h = b * this.maxCanvasWidth, i = h + a.canvas.width + 1;
      ...
      for (var e in this.canvases) {
        var f = this.canvases[e], g = e * this.maxCanvasWidth, h = {
